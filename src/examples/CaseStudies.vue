<template>
  <div>
    <section class="container-case-studies container-xxl">
      ...
      <div class="row" id="csr1">
        <div class="col">
          <a href="#">
            <div class="d-flex flex-sm-column">
              ...
              <p class="gray">Vantage Power accelerates time-to-market by six months reducing operational costs by over
                80%.</p>
          ...
          <div class="accordion-item">
            <img src="~@/assets/images/case_st/image1.png" alt="vector">
            <h2 class="accordion-header" id="csh1">
              <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#cs1"
                      aria-expanded="false" aria-controls="cs1">
                Technological independence and strong partnerships
              </button>
            </h2>
            <div id="cs1" class="accordion-collapse collapse" aria-labelledby="csh1" data-bs-parent="#csr1">
              <p class="body-text-bold">Automotive</p>
              <h4>Predictive
                Maintenance For Connected Vehicles</h4>
              <p class="gray">Vantage Power accelerates time-to-market by six months reducing operational costs by over
        ...
        <div class="col">
          ...
          <div class="accordion-item">
            <img src="~@/assets/images/case_st/image2.png" alt="vector">
            <h2 class="accordion-header" id="csh2">
              <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#cs2"
                      aria-expanded="false" aria-controls="cs2">
                Technological independence and strong partnerships
              </button>
            </h2>
            <div id="cs2" class="accordion-collapse collapse" aria-labelledby="csh2" data-bs-parent="#csr1">
              <p class="body-text-bold">Automotive</p>
              <h4>Predictive
                Maintenance For Connected Vehicles</h4>
              <p class="gray">Vantage Power accelerates time-to-market by six months reducing operational costs by over
        ...
        <div class="col">
          ...
          <div class="accordion-item">
            <img src="~@/assets/images/case_st/image3.png" alt="vector">
            <h2 class="accordion-header" id="csh3">
              <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#cs3"
                      aria-expanded="false" aria-controls="cs3">
                Integrated Distribution Management Systems
                For Electric Grids
              </button>
            </h2>
            <div id="cs3" class="accordion-collapse collapse" aria-labelledby="csh3" data-bs-parent="#csr1">
              <p class="body-text-bold">Automotive</p>
              <h4>VW’s CARIAD taps Luxoft for future oriented in car software solutions</h4>
              <p class="gray">Vantage Power accelerates time-to-market by six months reducing operational costs by over
                80%.</p>
      ...
      <div class="d-flex justify-center">
        <a class="btn btn-outline" href="#">view more case studies</a>
      </div>
    </section>

    <section class="container-featured container-xxl">
      <div class="title">
      ...
      <div class="row">
        <div class="col">
          ...
          <h4>Accelerate autonomous driving development with the Robotic Drive Innovation Lab</h4>
          <p class="gray">As relentless waves of change remodel the competitive business world, modernization
            initiatives</p>
          <button type="button" class="btn btn-text btn-icon focus">read more</button>
        </div>
        <div class="col">
          <img src="~@/assets/images/insights2.png" alt="">
          <h4>Luxoft to acquire CMORE Automotive, provider of data-driven autonomous </h4>
          <p class="gray">As relentless waves of change remodel the competitive business world, modernization
            initiatives</p>
          <button type="button" class="btn btn-text btn-icon focus">read more</button>
        </div>
        <div class="col">
          ...
          <h4>DXC Technology appoints Luz G. Mauch as Executive Vice President</h4>
          <p class="gray">As relentless waves of change remodel the competitive business world, modernization
            initiatives</p>
          <button type="button" class="btn btn-text btn-icon focus">read more</button>
        </div>
    ...
    <section class="featured container-xxl">
      <div class="container">
        <div class="row">
